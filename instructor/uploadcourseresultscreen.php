            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8"> 
                    <div class="card border-info">
                        <div class="card-header bg-info">SELECT THE STUDENT ID TO UPLOAD RESULT </div>
                        <div class="card-body">
                            <?php
                                include("../learn/database.php");
                                if (isset($_GET['coursecode'])) {
                                    ...
                                    if (mysqli_num_rows($select) <= 0) {
                                        ...
                                        <form method="post" action=""name="onload" class="form-horizontal" >
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" >Coursecode:</label>
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control"name="coursecode" value="<?php echo $coursecode1; ?>">
                                                </div><div class="col-sm-4"><p id="assign11"></p></div>
                                            </div>


                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="assign1">Assign 1:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="assign1">
                                                </div><div class="col-sm-4"><p id="assign11"></p></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="assign2">Assign 2:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="assign2">
                                                </div><div class="col-sm-4"><p id="assign22"></p></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="assign2">Quizz:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="quizz">
                                                </div><div class="col-sm-4"><p id="quizz1"></p></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="test1">Test 1:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="test1">
                                                </div><div class="col-sm-4"><p id="test11"></p></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="test2">Test 2:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="test2">
                                                </div><div class="col-sm-4"><p id="test22"></p></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="test3">Test 3:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="test3">
                                                </div><div class="col-sm-4"><p id="test33"></p></div>
                                            </div>  
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="test3">Final exam:</label>
                                                <div class="col-sm-2">
                                                    <input class="number-only" type="text" class="form-control"name="final">
                                                </div><div class="col-sm-4"><p id="test33"></p></div>
                                            </div> 
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="test3">Total:</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <button type="submit" class="btn btn-success"name="upload"value="upload"><i class="fa fa-1x fa-upload">Upload</i></button>
                                                </div>
                                            </div>
                                        </form>
                                        <?php
                                ...
                                if (isset($_POST['upload'])) {
                                    ...
                                    $grade = $_POST['grade'];                                          
                                        //  $total2 = $assign1 + $assign2 + $test1 + $test2 + $test3 + $total2 + $quizz + $final_exam;
                                            $select3 = mysqli_query($conn,"update coursestudent set assign1=$assign1,assign2='$assign2',test1='$test1',test2='$test2',test3='$test3',quizz='$quizz' where studentid='$student1' AND coursecode='$coursecode'");
                                            if ($select3) {
