                ...
                <div class="col-sm-12 col-md-8">  
                    <div class="card border-info">
                        <div class="card-header bg-info">
                            <h5 class="card-title">View Notice Pages</h5>
                        </div>
                        <div class="card-body">
                            <?php
                            error_reporting(0);
                            ...
                            <table class="table">
                                ...
                                while ($row3 = mysqli_fetch_array($select2)) {
                                    ...
                                    <tr class="active"> 
                                        ...
                                        <td><?php echo 'LEFT  +     ' . $days; ?> </td>
                                        <td><a href="notice/<?php echo $row3['filename'] ?>" target="_self">
                                                <i class="fa fa-1x fa-eye text-danger" aria-hidden="true"></i>
                                            </a>
                                        </td>
                                    </tr>
                                <?php }
